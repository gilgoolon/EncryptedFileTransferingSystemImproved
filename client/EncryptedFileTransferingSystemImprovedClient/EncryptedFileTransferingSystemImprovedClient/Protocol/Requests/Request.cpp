...
{
	return concat_vectors(serialize_uint<uint8_t>(CLIENT_VERSION), serialize_uint<uint16_t>(static_cast<uint16_t>(m_request_code)), serialize_uint<uint32_t>(m_payload_size));
}
